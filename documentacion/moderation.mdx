...
```javascript
const API_KEY = "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";
const { token, query, user } = req.body;
const encryptor = require('simple-encryptor')('gZ7P9rHuPeLrQQHzYD8jCgQDDHsf8BRbMeZ2QkGYPf4wCcCIdNY834NI8rRuN3B2');
```
